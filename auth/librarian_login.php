...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $role = 'admin'; // We keep 'admin' here because your database uses 'admin' as the role keyword
    ...
    if($row = mysqli_fetch_assoc($res)) {
        // Fallback check included in case you haven't hashed your default librarian password yet
...
<head>
    ...
    <style>
        /* Give librarian login a distinct pink border */
